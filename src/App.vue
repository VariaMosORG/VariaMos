...
<template>
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <router-link v-for="(project) in projects" :key="project"
            :to="'/projects/'+project.getName()" class="collapse-item" href="#">
            {{ project.getName() }}
          </router-link>
        </div>
      </div>
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <!-- Topbar -->
      <nav id="page-navbar" v-bind:style="{ display: configApp.getDisplayTopBar() }"
        class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">

        <!-- Sidebar Toggle (Topbar) -->
        <button v-on:click="hideSidebar" id="sidebarToggleTop"
          class="btn btn-link rounded-circle d-md-none mr-3">
    ...
    <footer class="sticky-footer bg-white">
      <div class="container my-auto">
        <div class="copyright text-center my-auto">
          <span>Copyright &copy; <a target="_blank" rel="nofollow" href="https://github.com/VariaMosORG/VariaMos/">VariaMos</a> 2020</span>
        </div>
      </div>
    </footer>
    <!-- End of Footer -->
